...
<tr>
              ...
              <tr>
                <td><button <?php if ($is_tcat_shipping) { ?> id="btn_tcat_create" <?php } ?> data-toggle="tooltip" title="<?php echo $text_shipping_method; ?>" class="btn btn-info btn-xs"><i class="fa fa-truck fa-fw"></i></button></td>
