...
--><input type="hidden" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-shipping-lastname" class="form-control" />
...
--><select name="country_id" id="input-shipping-country" class="form-control" style="display:none"> </select>
  <div class="form-group required">
