...
$this->load->model('extension/d_quickcheckout/address');
        ...
        $this->session->data['delivery_date'] = (!empty($this->session->data['delivery_date'])) ? $this->session->data['delivery_date'] : $data['account'][$account]['confirm']['fields']['delivery_date']['value'];
        $this->session->data['confirm'] = array(
            'delivery_date' => '',
            'comment' => '',
