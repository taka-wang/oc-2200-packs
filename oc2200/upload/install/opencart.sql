...
CREATE TABLE `oc_order` (
  ...
  `payment_country_id` int(11) NOT NULL DEFAULT '206',
  `payment_zone` varchar(128) NOT NULL,
  `payment_zone_id` int(11) NOT NULL DEFAULT '3138',
  ...
  `shipping_country_id` int(11) NOT NULL DEFAULT '206',
  `shipping_zone` varchar(128) NOT NULL,
  `shipping_zone_id` int(11) NOT NULL DEFAULT '3138',
