	...
	protected function validateForm() {
		...
		if (isset($this->request->post['address'])) {
			foreach ($this->request->post['address'] as $key => $value) {
				...
				/* taka: fix
				@https://github.com/opencart/opencart/issues/4522
				@https://stackoverflow.com/questions/35939201/syntax-error-unexpected-t-boolean-and-expecting-in-opencart-when-cl
				@https://github.com/opencart/opencart/blob/2.3.x/upload/admin/controller/customer/customer.php#L1102
				*/
				foreach ($custom_fields as $custom_field) {
